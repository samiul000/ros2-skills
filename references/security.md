<!-- SCOPE: SROS2, DDS security plugins, keystore/enclave setup, certificates, supply chain.
     NOT HERE: DDS tuning without security (→ communication.md), deployment hardening (→ deployment.md) -->
