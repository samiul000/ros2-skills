<!-- SCOPE: ros2 doctor, tracing, Foxglove, MCAP, rosbag2, bag replay QoS, CLI cheat sheet.
     NOT HERE: QoS profile design (→ communication.md), RT profiling tools (→ realtime.md) -->
