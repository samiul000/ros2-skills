<!-- SCOPE: ros2_control SystemInterface, controller manager, hardware abstraction, EtherCAT, controller chaining.
     NOT HERE: lifecycle callbacks in general (→ lifecycle-components.md), RT kernel setup (→ realtime.md), URDF basics (→ tf2-urdf.md) -->
...
trajectory_controller:
  ros__parameters:
    ...
    command_interfaces:
      [
        velocity_pid/joint_1/velocity_reference,
