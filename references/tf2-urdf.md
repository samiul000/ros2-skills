<!-- SCOPE: tf2 API, URDF authoring, xacro macros, robot_state_publisher, static transforms.
     NOT HERE: ros2_control URDF tag (→ hardware-interface.md), simulation frames (→ simulation.md) -->
