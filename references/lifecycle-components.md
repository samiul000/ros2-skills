<!-- SCOPE: managed node state machine, component loading, composable containers, intra-process composition.
     NOT HERE: node basics (→ nodes-executors.md), launch composition syntax (→ launch-system.md) -->
