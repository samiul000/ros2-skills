<!-- SCOPE: gtest, pytest, launch_testing, industrial_ci, parameter testing, CI/CD pipelines.
     NOT HERE: build config (→ workspace-build.md), Docker deployment (→ deployment.md) -->
