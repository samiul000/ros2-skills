<!-- SCOPE: ROS 1 → ROS 2 migration strategy, ros1_bridge, hybrid operation, API mapping.
     NOT HERE: modern ROS 2 patterns (→ nodes-executors.md), build system differences (→ workspace-build.md) -->
