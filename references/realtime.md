<!-- SCOPE: PREEMPT_RT kernel, realtime_tools, memory locking, CPU isolation, jitter measurement.
     NOT HERE: hardware interface code (→ hardware-interface.md), executor threading (→ nodes-executors.md) -->
