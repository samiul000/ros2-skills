<!-- SCOPE: MoveIt 2, MTC, planning scene, grasp pipelines, servo, collision objects.
     NOT HERE: ros2_control integration (→ hardware-interface.md), tf2 frames (→ tf2-urdf.md) -->
