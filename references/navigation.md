<!-- SCOPE: Nav2 stack, AMCL, costmaps, BT navigator, SLAM, collision monitor, recovery behaviors.
     NOT HERE: tf2/URDF for robot model (→ tf2-urdf.md), simulation setup (→ simulation.md) -->
