<!-- SCOPE: message field conventions, units, covariance matrices, frame conventions, diagnostics format.
     NOT HERE: custom interface package setup (→ workspace-build.md), QoS for message delivery (→ communication.md) -->
