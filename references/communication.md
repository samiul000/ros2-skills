<!-- SCOPE: topics, services, actions, QoS profiles, DDS tuning, type adapters, custom interfaces.
     NOT HERE: executor threading (→ nodes-executors.md), bag replay QoS (→ debugging.md), SROS2 (→ security.md) -->
