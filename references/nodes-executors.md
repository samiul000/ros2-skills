<!-- SCOPE: rclcpp/rclpy node classes, executors, callback groups, intra-process comms, parameters.
     NOT HERE: QoS profiles (→ communication.md), lifecycle state machine (→ lifecycle-components.md), RT constraints (→ realtime.md) -->
...
WaitSets are powerful because you decide _exactly_ the order in which to check
