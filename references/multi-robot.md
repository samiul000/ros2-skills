<!-- SCOPE: Open-RMF, multi-robot namespacing, DDS discovery isolation, fleet manager patterns.
     NOT HERE: single-robot Nav2 (→ navigation.md), DDS security (→ security.md), deployment infra (→ deployment.md) -->
