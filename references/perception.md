<!-- SCOPE: image_transport, cv_bridge, PCL, depth processing, camera calibration, Isaac ROS.
     NOT HERE: simulation sensors (→ simulation.md), tf2 camera frames (→ tf2-urdf.md) -->
