<!-- SCOPE: micro-ROS, rclc API, XRCE-DDS agent, static memory, ESP32/STM32/RP2040 firmware.
     NOT HERE: standard rclcpp/rclpy nodes (→ nodes-executors.md), DDS on full Linux (→ communication.md) -->
