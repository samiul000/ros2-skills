<!-- SCOPE: Gazebo Sim (Ionic/Harmonic), Isaac Sim setup, gz_ros2_control, sim-to-real transfer, use_sim_time.
     NOT HERE: Nav2 tuning (→ navigation.md), sensor processing (→ perception.md), RT constraints (→ realtime.md) -->
